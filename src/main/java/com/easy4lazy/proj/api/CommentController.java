...
public class CommentController {
    ...
    /****
     @GetMapping(path="/get/{uid}/{id}") public String getAnswerComments(@PathVariable("uid") int userId, @PathVariable("id") @Valid @NotNull int answerId){
     return commentService.getAnswerComments(userId, answerId);
     }

     @DeleteMapping(path="/del/{uid}/{token}/{id}") public String deleteComment(@PathVariable("uid") @Valid @NotNull int userId, @PathVariable("token") @Valid @NotNull String token, @PathVariable("id") @Valid @NotNull int contentId){
